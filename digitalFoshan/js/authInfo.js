	...
	$.ajax({
		...
		success: (res) => {
			if (res.ret == 1) {
				...
				res.link =
					'http://api.foshanplus.com/foshan/api/v2/wxAuthorize?redirectUri=https%3a%2f%2fcontent.foshanplus.com%2fh5%2ffoshan_story_project%2findex.html'
				initSign(res)
			}
		},
	})
