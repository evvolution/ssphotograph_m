...
function getSign() {
	newstitle = '温爱佛山 乐善之城'
	newsdesc = '快来戳！一起看看2019公益慈善年度优秀都有谁？'
	$.ajax({
		url:
			authInfo.api +
			'/getSign?url=' +
		...
		success: (res) => {
			if (res.ret == 1) {
				...
				res.link =
					'http://api.foshanplus.com/foshan/api/v2/wxAuthorize?redirectUri=https%3a%2f%2fcontent.foshanplus.com%2fh5%2fcharity_project%2findex.html'
				initSign(res)
			}
		},
	})
