...
// var faceimage = 'https://fsnewsres.foshanplus.com/h5/cclawVote2020/pf.jpg'
var newstitle = '2020佛山教育口碑榜·年度佛山家长信赖品牌幼儿园'
var newsdesc = '“2020佛山教育口碑榜·年度佛山家长信赖品牌幼儿园”评选'
var authInfo = {
	...
	$.ajax({
		...
		success: (res) => {
			if (res.ret == 1) {
				...
				res.link = 'https://content.foshanplus.com/h5/eduKB2020/index.html'
				initSign(res)
			}
		},
	})
