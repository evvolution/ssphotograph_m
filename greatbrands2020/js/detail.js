...
var id = getParam('id');
// sessionStorage.setItem('Readed', id)
//加载数据、投票和投票功能
$(document).ready(function(e){

})

//https://api.foshanplus.com/foshan/api/v2/getNewsDetailsById?newsid=544963
// 获取详情数据
        ...
        success:function(receiver){
            ...
            if (receiver.ret == 1) {
                ...
                if(receiver.activityItem.description == ""){
                    ...
                    $("#author").html(receiver.activityItem.description)
                }
...
function backpage() {
    // window.location.href = 'https://content.foshanplus.com/h5/greatbrands2020/index.html?voted=' + id;
...
function share() {
    ...
    if (!authInfo.is_weixin) {
        ...
        if (isAndroid && window.ZMBridge) {
            window.ZMBridge.share(title, second, logo, "https://content.foshanplus.com/h5/greatbrands2020/detail.html?id=" + id, type); 
        } else if (
            isiOS &&
            window.webkit &&
            ...
            window.webkit.messageHandlers.share.postMessage({ title:title, desc:second, img:logo, url: 'https://content.foshanplus.com/h5/greatbrands2020/detail.html?id=' + id, shareType:type});
        }
    }
}
