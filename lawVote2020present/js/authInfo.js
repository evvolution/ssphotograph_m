// var faceimage = 'https://fsnewsres.foshanplus.com/h5/ccgreenvote/ccgreenVoteshare.jpg'
var faceimage = 'https://content.foshanplus.com/foshanlogo.png'
var newstitle = ''
var newsdesc = '“谁执法谁普法”现场投票'
var authInfo = {
		...
		success: (res) => {
			if (res.ret == 1) {
				...
				if((mo == "") || (d == "") || (h == "") || (m == "") || (s == "")){
					...
					res.link = 'https://content.foshanplus.com/h5/lawVote2020present/vote.html' + '?lawmo=' + mo + '&lawd=' + d + '&lawh=' + h + '&lawm=' + m + '&laws=' + s;
					initSign(res)
				}
			}
		},
