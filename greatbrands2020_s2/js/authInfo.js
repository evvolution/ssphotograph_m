...
var authInfo = {
	...
	activityId: 4, // 活动id
	activityCode: 'fskbbtp_lottery_2020',
	activity: {
		description: '佛山+红包抽奖',
		title: '佛山+红包抽奖',
		...
		$.ajax({
			...
			success: (res) => {
				...
				if(res.ret == 0) {
					...
					$('#red_get_num').html(parseFloat(parseInt(res.data.amount) / 100))
	...
	$.ajax({
		...
		success: (res) => {
			if (res.ret == 1) {
				...
				res.link = 'https://content.foshanplus.com/h5/greatbrands2020_s2/index.html'
				initSign(res)
			}
		},
	})
